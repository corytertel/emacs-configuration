...
(defun create-spacemacs-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ;;                                                          GUI       TER                           GUI       TER
        ;; generic
        (act1          (if (eq variant 'dark) (if (true-color-p) "#eaeaea" "#121212") (if (true-color-p) "#e7e5eb" "#d7dfff")))
        (act2          (if (eq variant 'dark) (if (true-color-p) "#eaeaea" "#444444") (if (true-color-p) "#d3d3e7" "#afafd7")))
        ...
        (border        (if (eq variant 'dark) (if (true-color-p) "#000000" "#111111") (if (true-color-p) "#b3b9be" "#b3b9be")))
        (cblk          (if (eq variant 'dark) (if (true-color-p) "#000000" "#b2b2b2") (if (true-color-p) "#655370" "#5f5f87")))
        (cblk-bg       (if (eq variant 'dark) (if (true-color-p) "#eaeaea" "#262626") (if (true-color-p) "#e8e3f0" "#ffffff")))
        (cblk-ln       (if (eq variant 'dark) (if (true-color-p) "#770077" "#af5faf") (if (true-color-p) "#9380b2" "#af5fdf")))
        (cblk-ln-bg    (if (eq variant 'dark) (if (true-color-p) "#eaeaea" "#333333") (if (true-color-p) "#ddd8eb" "#dfdfff")))
        ...
        (comment       (if (eq variant 'dark) (if (true-color-p) "#663311" "#008787") (if (true-color-p) "#2aa1ae" "#008787")))
        (comment-light (if (eq variant 'dark) (if (true-color-p) "#663311" "#008787") (if (true-color-p) "#a49da5" "#008787")))
        ...
        (func          (if (eq variant 'dark) (if (true-color-p) "#004488" "#d75fd7") (if (true-color-p) "#6c3163" "#8700af")))
        ...
        (head4         (if (eq variant 'dark) (if (true-color-p) "#004488" "#875f00") (if (true-color-p) "#b1951d" "#875f00")))
        (head4-bg      (if (eq variant 'dark) (if (true-color-p) "#ffffea" "#262626") (if (true-color-p) "#f6f1e1" "#ffffff")))
        (highlight     (if (eq variant 'dark) (if (true-color-p) "#eeee9e" "#444444") (if (true-color-p) "#d3d3e7" "#d7d7ff")))
        (highlight-dim (if (eq variant 'dark) (if (true-color-p) "#eeee9e" "#444444") (if (true-color-p) "#e7e7fc" "#d7d7ff")))
        (keyword       (if (eq variant 'dark) (if (true-color-p) "#880000" "#268bd2") (if (true-color-p) "#3a81c3" "#268bd2")))
        (lnum          (if (eq variant 'dark) (if (true-color-p) "#000000" "#444444") (if (true-color-p) "#a8a8bf" "#af87af")))
        (mat           (if (eq variant 'dark) (if (true-color-p) "#000000" "#86dc2f") (if (true-color-p) "#ba2f59" "#af005f")))
        (meta          (if (eq variant 'dark) (if (true-color-p) "#004488" "#af875f") (if (true-color-p) "#da8b55" "#df5f5f")))
        ...
        (var           (if (eq variant 'dark) (if (true-color-p) "#663311" "#8787d7") (if (true-color-p) "#715ab1" "#af5fd7")))
